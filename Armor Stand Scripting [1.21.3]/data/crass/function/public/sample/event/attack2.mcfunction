...
## raise arm
# set up the payload
data modify storage crass:sample root.payload set value {time:12,lerp:"icbrt"}
data modify storage crass:sample root.payload.LeftArm set value {values:[-190f,0f,2f]}
data modify storage crass:sample root.payload.RightArm set value {values:[-190f,0f,-20f]}
...
data modify storage crass:sample root.payload.LeftArm set value {values:[-49f,17f,-10f]}
data modify storage crass:sample root.payload.RightArm set value {values:[-63f,0f,15f]}
