...
function crass:storage/strcmp {1:"crass:statue root.math.1", 2:"crass:statue root.math.2"}

# 0 if uuids match
#tellraw @a [{"text":"V - 0 if uuids match"}]
#tellraw @a [{"score":{"name":"#strcmp","objective": "co_math"}}]
#function crass:storage/print_storage {storage:"crass:statue root.math.1"}
#function crass:storage/print_storage {storage:"crass:statue root.math.2"}
...
#function crass:storage/print_storage {storage:"crass:statue root.temp.contains"}
