...
#$function crass:storage/operation_storage {str:"crass:statue root.temp.limb_pos",op:"-",mod:"crass:statue root.$(uuid).timeline_$(id)_object.old_pose.$(limb)[$(axis)]"}
...
#function crass:storage/operation_storage {str:"crass:statue root.temp.limb_pos",op:"*",mod:"crass:statue root.temp.limb_interpolate"}
#function crass:storage/operation {str:"crass:statue root.temp.limb_pos",op:"/",mod:"10000"}
