...
data modify storage cooley:sample root.payload.RightLeg set value {values:[20f,0f,1f]}
...
data modify storage cooley:sample root.payload.LeftArm set value {values:[20f,0f,1f]}
data modify storage cooley:sample root.payload.RightArm set value {values:[-20f,0f,1f]}
