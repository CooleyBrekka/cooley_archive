data merge storage cooley:statue {root:{NoGravity:"1b"}}
...
execute if data storage cooley:statue {root:{pose:"default_gravity"}} run data merge storage cooley:statue {root:{top_offset:"^ ^ ^",bottom_offset:"^ ^ ^", NoGravity:"0b"}}
