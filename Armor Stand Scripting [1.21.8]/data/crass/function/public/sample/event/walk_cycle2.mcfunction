...
# set up the payload
data modify storage crass:sample root.payload set value {time:15,fsm:"walk_cycle2",lerp:"cbrt"}
data modify storage crass:sample root.payload.LeftLeg set value {values:[20f,0f,1f]}
data modify storage crass:sample root.payload.RightLeg set value {values:[340f,0f,1f]}
...
data modify storage crass:sample root.payload.LeftArm set value {values:[340f,0f,1f]}
