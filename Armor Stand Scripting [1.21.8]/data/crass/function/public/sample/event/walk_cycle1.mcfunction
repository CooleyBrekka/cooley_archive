...
data modify storage crass:sample root.payload.LeftLeg set value {values:[340f,0f,1f]}
...
data modify storage crass:sample root.payload.RightArm set value {values:[340f,0f,1f]}
