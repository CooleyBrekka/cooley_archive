...
$execute if score #find_timeline co_math matches 0 run function coco:storage/operation {str:"crass:statue root.$(uuid).timelines_length",op:"+",mod:1}
...
# increment length by 1
$function coco:storage/operation {str:"crass:statue root.$(uuid).timeline_$(timeline_id)_length",op:"+",mod:1}
