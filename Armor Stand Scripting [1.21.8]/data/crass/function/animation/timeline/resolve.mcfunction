...
# calculate loop num
$function coco:storage/operation_storage {str:"crass:statue root.temp.resolve",op:"",mod:"crass:statue root.$(marker).timeline_$(timeline)_object.duration"}
$function coco:storage/operation_storage {str:"crass:statue root.temp.resolve",op:"-",mod:"crass:statue root.$(marker).timeline_$(timeline)_object.current_time"}

# prep forloop
$data modify storage crass:statue root.temp.prep_resolve set value {uuid:"$(marker)",id:"$(timeline)"}
function coco:storage/operation_storage {str:"crass:statue root.temp.max_iter",op:"",mod:"crass:statue root.temp.resolve"}
...
function coco:storage/forloop with storage crass:statue root.temp
