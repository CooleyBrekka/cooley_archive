...
$function crass:animation/timeline/process/lerp/$(lerp)
...
$data modify storage crass:statue root.temp.feet set from storage crass:statue root.$(uuid)_bind.feet
$data modify storage crass:statue root.temp.hands set from storage crass:statue root.$(uuid)_bind.hands

# calculate position for limbs
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.Head if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"Head",uuid:"$(uuid)",id:"$(id)"}
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.Body if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"Body",uuid:"$(uuid)",id:"$(id)"}
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.RightLeg if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"RightLeg",uuid:"$(uuid)",id:"$(id)"}
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.LeftLeg if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"LeftLeg",uuid:"$(uuid)",id:"$(id)"}
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.RightArm if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"RightArm",uuid:"$(uuid)",id:"$(id)"}
$execute if data storage crass:statue root.$(uuid).timeline_$(id)_object.new_pose.LeftArm if score #take_action co_math matches 1 run function crass:animation/timeline/process/update_limb {limb:"LeftArm",uuid:"$(uuid)",id:"$(id)"}
...
$execute if score $(uuid)_$(id) co_duration matches -1 unless data storage crass:statue root.$(uuid).timeline_$(id)[0] run scoreboard players set #object_exit co_math 0
...
#$execute if score #object_exit co_math matches 1 run say data remove storage crass:statue root.$(uuid).timeline_$(id)_object
